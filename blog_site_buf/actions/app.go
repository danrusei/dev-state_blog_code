...
func App() *buffalo.App {
	if app == nil {
		app = buffalo.New(buffalo.Options{
			Env:         ENV,
			SessionName: "_blog_site_buf_session",
		})
		...
		app.Middleware.Skip(Authorize, PostsIndex, PostsDetail)
		commentsGroup := app.Group("/comments")
		commentsGroup.Use(Authorize)
		commentsGroup.POST("/create/{pid}", CommentsCreate)
