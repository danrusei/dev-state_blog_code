...
import (
	...
	"github.com/danrusei/dev-state_blog_code/tree/master/constructors/constr_Go/car1"
	"github.com/danrusei/dev-state_blog_code/tree/master/constructors/constr_Go/car2"
)
...
func main() {
	...
	// Example usage with Functional Options Pattern
	car_ex2 := car2.NewCar(
